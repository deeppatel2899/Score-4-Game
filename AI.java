...
//{
	...
	//char[][][] board = new char[4][4][4];
		...
		//{
			...
			//M = ai.findMove(board);
			//System.out.printf("The value of the best Move " + "is : %d-%d-%d\n",M.row,M.col,M.bead); 
			//board[M.row][M.col][M.bead]='o';
			//ai.dis(board);
			//win = ai.evaluate(board);
			//if(win == 10)
			//{
			...
			//{
				...
				//else
				//{
					//System.out.println("Row and Column must between 1 to 4 !");
				//}
